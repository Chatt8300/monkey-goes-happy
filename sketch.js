...
function preload(){
  ...
  restartImage = loadImage("restarter.png")
...
function setup(){
 createCanvas(550,300);
  ...
  restart = createSprite(295, 255, 10, 10 )
...
function draw(){
  ...
  if (gameState === PLAY){
    ...
    ground.velocityX = -(5+score*1.5/100);
  ...
  if (gameState === END){
    ...
    textSize(15);
    textFont("fantasy")
    text("Press 'R' to play again", 230, 200);
